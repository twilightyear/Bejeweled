...
//------------------------------------------------------------------------------
    ...
    public:
        ...
        inline Fl_Widget* getFlWidget() { return pw; }
...
//------------------------------------------------------------------------------
    ...
    struct ImageButton : Widget {
        ImageButton(Point xy, const string& image_path, Callback cb)
            : Widget(xy,0,0,image_path,cb)
        {
            image = new Fl_JPEG_Image(image_path.c_str());
        ...
        void updateImage(const string& image_path)
        {
